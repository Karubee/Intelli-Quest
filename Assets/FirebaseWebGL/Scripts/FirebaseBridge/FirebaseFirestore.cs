...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseFirestore
    {
        ...
        /// <param name="callback"> Name of the method to call when the operation is successful. Method must have signature: void Method(string userData) </param>
        ...
        [DllImport("__Internal")]
        public static extern void GetUserData(string userId, string objectName, string callback, string fallback);

        /// <summary>
        /// Sets user data in Firestore
        /// </summary>
        /// <param name="userId"> The unique identifier of the user </param>
        /// <param name="userData"> A JSON string representing the user data to be stored </param>
        /// <param name="objectName"> Name of the GameObject to call the callback/fallback on </param>
        ...
        /// <param name="fallback"> Name of the method to call when the operation is unsuccessful. Method must have signature: void Method(string errorMessage) </param>
        [DllImport("__Internal")]
        public static extern void SetUserData(string userId, string userData, string objectName, string callback, string fallback);
