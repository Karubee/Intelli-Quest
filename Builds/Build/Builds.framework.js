...
var ASM_CONSTS = {
  4414144: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4414205: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4414269: function() {return Module.webglContextAttributes.powerPreference;},  
 4414327: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4414382: function($0) {performance.now = function() { return $0; };},  
 4414430: function($0) {performance.now = function() { return $0; };},  
 4414478: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _DownloadFileFromStorage(path, objectName, callback, fallback) {
      var parsedPath = Pointer_stringify(path);
      var parsedObjectName = Pointer_stringify(objectName);
      var parsedCallback = Pointer_stringify(callback);
      var parsedFallback = Pointer_stringify(fallback);
  ...
  function _UploadFileToStorage(path, data, objectName, callback, fallback) {
      var parsedPath = Pointer_stringify(path);
      ...
      try {
        ...
        firebase
          ...
          .then(function (snapshot) {
            // After uploading the file, get the download URL
            return snapshot.ref.getDownloadURL();
          })
          .then(function (downloadUrl) {
            // Send the download URL to Unity as the success message
            unityInstance.Module.SendMessage(
              parsedObjectName,
              parsedCallback,
              downloadUrl
          ...
          .catch(function (error) {
            // Handle any errors during the upload or URL retrieval process
            unityInstance.Module.SendMessage(
              parsedObjectName,
              parsedFallback,
              JSON.stringify(error, Object.getOwnPropertyNames(error))
...
var asmLibraryArg = {
  ...
  "DownloadFileFromStorage": _DownloadFileFromStorage,
  ...
  "UploadFileToStorage": _UploadFileToStorage,
